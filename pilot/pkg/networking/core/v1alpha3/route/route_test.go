...
func TestBuildHTTPRoutes(t *testing.T) {
	...
	t.Run("for virtual service", func(t *testing.T) {
		...
		g.Expect(routes[0].GetRoute().MaxGrpcTimeout.Seconds).To(gomega.Equal(int64(0))) //nolint:staticcheck
	})
	...
	t.Run("for virtual service with changed default timeout", func(t *testing.T) {
		...
		g.Expect(routes[0].GetRoute().MaxGrpcTimeout.Seconds).To(gomega.Equal(int64(1))) //nolint:staticcheck
	})
	...
	t.Run("for virtual service with timeout", func(t *testing.T) {
		...
		g.Expect(routes[0].GetRoute().MaxGrpcTimeout.Seconds).To(gomega.Equal(int64(10))) //nolint:staticcheck
	})
