...
go test -count=1 -tags=integ -timeout 30m ./tests/integration/mixer/. -p 1 -test.v
...
go test -count=1 -tags=integ -timeout 30m -run='TestStatsFilter|TestStatsFilter|TestSetup|TestWasmStatsFilter|TestTcpMetric|TestIstioctlMetrics' ./tests/integration/telemetry/stats/... -p 1 -test.v
