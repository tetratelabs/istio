...
for package in $PACKAGES; do
  ...
  do
    ...
    go test -test.v -tags=integ $package -timeout 30m --istio.test.select=-postsubmit,-flaky --istio.test.ci --istio.test.pullpolicy IfNotPresent && break || echo "Test Failed: $package"
