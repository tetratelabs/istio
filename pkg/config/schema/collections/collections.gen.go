...
var (
	...
	BackendTLSPolicy = resource.Builder{
		...
		Version:    "v1",
		Proto:      "k8s.io.gateway_api.api.v1.BackendTLSPolicySpec", StatusProto: "k8s.io.gateway_api.api.v1alpha2.PolicyStatus",
		ReflectType: reflect.TypeOf(&sigsk8siogatewayapiapisv1.BackendTLSPolicySpec{}).Elem(), StatusType: reflect.TypeOf(&sigsk8siogatewayapiapisv1alpha2.PolicyStatus{}).Elem(),
		ProtoPackage: "sigs.k8s.io/gateway-api/apis/v1", StatusPackage: "sigs.k8s.io/gateway-api/apis/v1alpha2",
		ClusterScoped: false,
		Synthetic:     false,
		Builtin:       false,
