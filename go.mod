...
replace (
	...
	cloud.google.com/go/compute => cloud.google.com/go/compute v1.25.1 // indirect
	...
	github.com/google/pprof => github.com/google/pprof v0.0.0-20240227163752-401108e1b7e7 // indirect
	github.com/grpc-ecosystem/grpc-gateway/v2 => github.com/grpc-ecosystem/grpc-gateway/v2 v2.19.1 // indirect
	...
	github.com/onsi/ginkgo/v2 => github.com/onsi/ginkgo/v2 v2.17.1 // indirect
	...
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.11 // indirect
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.11 // indirect
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc => go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.49.0 // indirect
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.49.0 // indirect
	...
	k8s.io/component-base => k8s.io/component-base v0.30.0 // indirect
	...
	k8s.io/utils => k8s.io/utils v0.0.0-20240423183400-0849a56e8f22
