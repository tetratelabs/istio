...
replace github.com/envoyproxy/go-control-plane v0.11.1-0.20230524094728-9239064ad72f => github.com/envoyproxy/go-control-plane v0.10.3-0.20220908185826-2b9739221838

replace google.golang.org/grpc v1.49.0 => google.golang.org/grpc v1.56.3
