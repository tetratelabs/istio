...
replace (
	...
	github.com/quic-go/qpack => github.com/quic-go/qpack v0.4.0 // indirect
	// TIS: Lock versions
	...
	golang.org/x/term => golang.org/x/term v0.21.0 // indirect
	golang.org/x/text => golang.org/x/text v0.16.0 // indirect
)
