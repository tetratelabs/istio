...
replace (
	cloud.google.com/go/compute => cloud.google.com/go/compute v1.23.3 // indirect
	cloud.google.com/go/compute/metadata => cloud.google.com/go/compute/metadata v0.2.3
	github.com/BurntSushi/toml => github.com/BurntSushi/toml v1.3.2 // indirect
	...
	github.com/antlr/antlr4/runtime/Go/antlr/v4 => github.com/antlr/antlr4/runtime/Go/antlr/v4 v4.0.0-20230305170008-8188dc5388df // indirect
	...
	github.com/cncf/udpa/go => github.com/cncf/udpa/go v0.0.0-20220112060539-c52dc94e7fbe // indirect
	github.com/cncf/xds/go => github.com/cncf/xds/go v0.0.0-20231128003011-0fa0005c9caa
	github.com/cpuguy83/go-md2man/v2 => github.com/cpuguy83/go-md2man/v2 v2.0.3 // indirect
	github.com/cyphar/filepath-securejoin => github.com/cyphar/filepath-securejoin v0.2.4 // indirect
	github.com/docker/cli => github.com/docker/cli v24.0.7+incompatible
	github.com/evanphx/json-patch => github.com/evanphx/json-patch v5.7.0+incompatible // indirect
	github.com/go-jose/go-jose/v3 => github.com/go-jose/go-jose/v3 v3.0.4
	github.com/go-logr/logr => github.com/go-logr/logr v1.4.1
	github.com/go-openapi/jsonpointer => github.com/go-openapi/jsonpointer v0.20.2 // indirect
	github.com/go-openapi/swag => github.com/go-openapi/swag v0.22.7 // indirect
	github.com/go-task/slim-sprig => github.com/go-task/slim-sprig v0.0.0-20230315185526-52ccab3ef572 // indirect
	github.com/google/cel-go => github.com/google/cel-go v0.17.7
	github.com/google/pprof => github.com/google/pprof v0.0.0-20231205033806-a5a03c77bf08 // indirect
	github.com/grpc-ecosystem/grpc-gateway/v2 => github.com/grpc-ecosystem/grpc-gateway/v2 v2.18.1 // indirect
	github.com/huandu/xstrings => github.com/huandu/xstrings v1.4.0 // indirect

	github.com/imdario/mergo => github.com/imdario/mergo v0.3.5
	github.com/matttproud/golang_protobuf_extensions/v2 => github.com/matttproud/golang_protobuf_extensions/v2 v2.0.0 // indirect
	github.com/moby/spdystream => github.com/moby/spdystream v0.2.0 // indirect
	github.com/onsi/ginkgo/v2 => github.com/onsi/ginkgo/v2 v2.13.2 // indirect
	github.com/onsi/gomega => github.com/onsi/gomega v1.30.0
	github.com/opencontainers/image-spec => github.com/opencontainers/image-spec v1.1.0-rc5 // indirect
	...
	github.com/shopspring/decimal => github.com/shopspring/decimal v1.3.1 // indirect
	github.com/spf13/cast => github.com/spf13/cast v1.6.0 // indirect
	github.com/spf13/cobra => github.com/spf13/cobra v1.8.0
	github.com/stretchr/testify => github.com/stretchr/testify v1.9.0
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc => go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.1 // indirect
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.46.1 // indirect
	...
	google.golang.org/appengine => google.golang.org/appengine v1.6.8 // indirect
	google.golang.org/genproto/googleapis/api => google.golang.org/genproto/googleapis/api v0.0.0-20240318140521-94a12d6c2237
	google.golang.org/genproto/googleapis/rpc => google.golang.org/genproto/googleapis/rpc v0.0.0-20240314234333-6e1732d8331c
	google.golang.org/grpc => google.golang.org/grpc v1.62.2
	...
	k8s.io/component-base => k8s.io/component-base v0.29.0 // indirect
	k8s.io/klog/v2 => k8s.io/klog/v2 v2.120.0
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20240105020646-a37d4de58910 // indirect
	...
	sigs.k8s.io/kustomize/kyaml => sigs.k8s.io/kustomize/kyaml v0.16.0 // indirect
