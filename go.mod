...
// istio/api 1.7.5 + cherry pick commits that restore Kubernetes v1.15 support
replace istio.io/api => github.com/tetratelabs/istio-api v0.0.0-20210504133529-8856eb8635f0
