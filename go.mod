...
// istio/api 1.7.7 + cherry pick commits that restore Kubernetes v1.15 support
replace istio.io/api => github.com/tetratelabs/istio-api v0.0.0-20210504133701-708673586e4e
